...
void pblurfilter(const int xsize, const int ysize, pixel* src, const int radius, const double *w, const int startindex){
  int x,y,x2,y2, wi;
  double r,g,b,n, wc;



  for (y=startindex; y<startindex+ysize; y++) { // vertical direction/*
    for (x=0; x<xsize; x++) { // horizontal direction
